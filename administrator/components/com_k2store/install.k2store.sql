...
CREATE TABLE IF NOT EXISTS `#__k2store_orderinfo` (
...
-- country and zone table - create query --
			...
			CREATE TABLE IF NOT EXISTS `#__k2store_countries` (
			...
			CREATE TABLE IF NOT EXISTS `#__k2store_zones` (
...
-- insert data for countries table --
			...
			INSERT INTO `#__k2store_countries` (`country_id`, `country_name`, `country_isocode_2`, `country_isocode_3`, `state`) VALUES
			...
			INSERT INTO `#__k2store_zones` (`zone_id`, `country_id`, `zone_code`, `zone_name`, `state`) VALUES
