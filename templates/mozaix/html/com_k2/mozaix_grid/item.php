...
<h2 class="k2title"><?php echo $this->item->title; ?></h2>
...
<!-- k2 itembody open-->
  <div class="itemBody">
	   ...
	   <?php if($this->item->params->get('itemFeaturedNotice') && $this->item->featured): ?>
	  	...
	  	<?php endif; ?><!-- Plugins: BeforeDisplayContent -->
	...
	<div class="itemSocialSharing">
		...
		<div class="itemTwitterButton">
			<a href="https://twitter.com/share" class="twitter-share-button" data-count="horizontal"<?php if($this->item->params->get('twitterUsername')): ?> data-via="<?php echo $this->item->params->get('twitterUsername'); ?>"<?php endif; ?>>
				<i class=" icon-twitter"></i><?php echo JText::_('K2_TWEET'); ?>
			</a>
	...
	<?php endif; ?>
		...
		<div class="clr"></div>
<?php
	if($this->item->params->get('itemImageGallery') && !empty($this->item->gallery)) { $videoClass= "span5"; }
	else {$videoClass = "span12"; }

	if($this->item->params->get('itemVideo') && !empty($this->item->video)) { $galleryClass= "span6"; }
	else {$galleryClass = "span12"; }
?>
...
<?php if($this->item->params->get('itemVideo') && !empty($this->item->video)): ?>
  ...
  <div class="itemVideoBlock">
  	<h1><?php echo JText::_('K2_MEDIA'); ?></h1>
...
<?php if($this->item->params->get('itemImageGallery') && !empty($this->item->gallery)): ?>
 ...
 <div class="<?php echo $galleryClass; ?>">
  <!-- Item image gallery -->
       ...
       <!-- Item extra fields (Uncomment to enable title)
        ...
        -->
	  	<ul>
			...
			<li>
				<h1><?php echo $extraField->name; ?>:</h1><br />
