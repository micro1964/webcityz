	...
	<?php echo $this->item->event->K2BeforeDisplay; ?>
	  ...
	  <?php endif; ?>
       <?php if($this->item->params->get('catItemTitle')): ?>
          ...
          <div class="jnewstext"><h4>
			<a class="titlelink"  href="<?php echo $this->item->link; ?>">
	  		<?php echo $this->item->title; ?>
	  	</a></h4>
        </div>
	  	<?php else: ?> <div class="jnewstext">
	  	<h4><span class="titlelink"> <?php echo $this->item->title; ?></span></h4>
        </div>
	  	<?php endif; ?>
         <?php endif; ?>
