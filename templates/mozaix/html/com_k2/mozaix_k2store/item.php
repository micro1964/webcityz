...
<div id="k2Container" class="itemView<?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemToolbar k2storebar">
  <div class="itemInfos">
...
<div class="itemTools">
  ...
  <?php if($this->item->params->get('itemAuthorBlock') || 
          ...
          $this->item->params->get('itemVideo') || 
          $this->item->params->get('itemRelated')) {
         $thedivname = '';
          } else{
         $thedivname = 'fullwidth';
  } ?>
...
<?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
	  ...
	  <div class="itemImageBlock">
              	  	<?php if($this->item->params->get('itemFeaturedNotice') && $this->item->featured): ?>
                                <div class="<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?>"></div>
	  	<?php endif; ?>
...
<?php if($this->item->params->get('itemAuthorBlock') || $this->item->params->get('itemAuthorLatest') || $this->item->params->get('itemExtraFields') || $this->item->params->get('itemAttachments') || $this->item->params->get('itemVideo') || $this->item->params->get('itemRelated')): ?>
...
<?php
  ...
  <!-- Related items by tag -->
	<div class="itemRelatedk2store row-fluid">
		<h2><?php echo JText::_("K2_RELATED_ITEMS_BY_TAG"); ?></h2>
		<ul>
			<?php 
                        $relateditems= '';
                        foreach($this->relatedItems as $key=>$item): ?>
			<li class="span3 <?php echo ($key%2) ? "odd" : "even"; ?> relateditems<?php echo ($xyz++%4);?>">
...
<?php if($this->item->params->get('itemVideo') && !empty($this->item->video)): ?>
  ...
  <div class="itemVideoBlockk2store">
  	<h2><?php echo JText::_('K2_MEDIA'); ?></h2>
...
<div class="k2rightcolumn<?php echo $thedivname;?>">
...
<h2 class="product_name"><span><?php echo $this->item->title; ?></span></h2>
<?php endif; ?>
...
<?php if($this->item->params->get('itemGooglePlusOneButton',1)): ?>
		...
		<div class="itemGooglePlusOneButton">
			<g:plusone annotation="inline" width="1"></g:plusone>
    ...
    <br /><br /><br />
	  ...
	  <div class="itemExtraFields">
       <!-- Item extra fields (Uncomment to enable title)
        ...
        -->
	  	<ul>
			...
			<li>
				<h3><?php echo $extraField->name; ?>:</h3>
 ...
 <?php if($this->item->params->get('itemAuthorBlock') && empty($this->item->created_by_alias)): ?>
  ...
  <div class="itemAuthorBlock">
    ...
    <div class="itemAuthorDetails">
      	...
      	<a rel="author" href="<?php echo $this->item->author->link; ?>"> <h3 class="itemAuthorName"><?php echo $this->item->author->name; ?>     </h3></a>
